...
export default {
  ...
  methods: {
    ...
    storeClicked(storeNumber) {
      console.log('Store clicked:  ' + storeNumber);
...
<div>
    ...
    <div v-if="viewOption=='L' && storeList.length">
        <div v-for="(store, index) in storeList">
            <div @click="storeClicked(store.storeNumber)" style="display: table; width: 100%; margin-left: 10px; margin-top: 15px; cursor: pointer; color: white;" >
